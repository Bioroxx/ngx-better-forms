...
import { ConditionsMode } from '@ngx-better-forms/ngx-better-forms-core';
import { evaluateConditions, FormControlCondition } from './core';
...
export class BetterDisable {
  public static conditionalDisable(params: {
    ...
    return (control: AbstractControl): ValidationErrors | null => {
      ...
      const disable = evaluateConditions(
        control,
        params.conditions,
